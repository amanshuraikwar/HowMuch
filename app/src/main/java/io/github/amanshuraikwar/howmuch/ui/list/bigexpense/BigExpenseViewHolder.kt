package io.github.amanshuraikwar.howmuch.ui.list.bigexpense
 ...
 */
class BigExpenseViewHolder(itemView: View) : ViewHolder<BigExpenseListItem>(itemView) {

    companion object {
        @LayoutRes
        val LAYOUT = R.layout.item_expense_big
    }
    ...
    override fun bind(listItem: BigExpenseListItem,
