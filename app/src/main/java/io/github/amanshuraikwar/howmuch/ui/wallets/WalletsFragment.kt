...
class WalletsFragment
@Inject constructor(): BaseFragment<WalletsContract.View, WalletsContract.Presenter>(), WalletsContract.View {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        return inflater.inflate(R.layout.fragment_wallets, null)
    }
    ...
    abstract class DiModule {
        @Binds
        abstract fun presenter(presenter: WalletsContract.PresenterImpl)
